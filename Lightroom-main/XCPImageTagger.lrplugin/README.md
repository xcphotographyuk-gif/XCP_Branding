...
- **Stock Photography (Alamy, Shutterstock, Getty, Adobe Stock)** - Extensive keyword generation (25-50 keywords) using XCP structured three-layer keywording
...
### SEO Tagging
Professional SEO tagging using a structured three-layer keywording approach:
...
Notes: Optimized for Alamy. 35 keywords generated.
...
| Stock Keywords (SEO) | Generated keywords using XCP structured keywording |
...
├── SEOTaggingEngine.lua        # XCP structured SEO keyword generation
