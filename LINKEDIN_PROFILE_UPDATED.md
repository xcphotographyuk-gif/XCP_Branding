# LinkedIn Profile - Revenue-Optimized Version
## XC Photography - Xavier Clarke

**Your voice blended with conversion-focused positioning**
...
1. **Portfolio Highlight Reel** - Link to www.xcphotography.co/portfolio
2. **Client Success Story** - Article or case study
3. **Behind-the-Scenes Video** - If you have one
4. **Testimonial Post** - Client quote with visual
5. **Recent Project** - Update monthly
...
## SKILLS TO ADD (For SEO & Discovery)
...
Ask past clients for recommendations mentioning:
- Quality of work
- Professionalism
...
I'm updating my LinkedIn profile and would love a quick recommendation from you about our work together on [project]. If you could mention [specific result/benefit], that would be incredibly helpful for potential clients to see.
...
## ACTIVITY STRATEGY (Post 2-3x/Week)

**Monday:** Behind-the-scenes content
**Wednesday:** Client spotlight or tip
**Friday:** Portfolio piece or industry insight

Use the LinkedIn post templates in SOCIAL_MEDIA_IMPLEMENTATION.md

---

## WHY THIS VERSION WORKS:

1. **Broader Geographic Appeal** - "Brighton-based" + "International" = More opportunities
2. **Your Voice Preserved** - "Craft, culture, rebellion" + "ordinary into extraordinary"
3. **Clear Services** - Removes confusion about what you offer
4. **Strategic Keywords** - SEO-optimized for discovery
5. **Multiple CTAs** - Discovery call + portfolio + contact methods
6. **Social Proof Ready** - Recommendations section for credibility
7. **Conversion-Focused** - Clear path from profile view → booking

---

## NEXT STEPS:

1. Update LinkedIn profile with this About section (5 minutes)
2. Add Featured content (10 minutes)
3. List Services with pricing (5 minutes)
4. Request 3-5 recommendations from past clients (10 minutes)
5. Start posting 2-3x/week using templates

**Total setup time: 30-40 minutes**
**Expected impact: 3-5× more profile views, 2-3× more connection requests, 1-2 inquiries/week**
